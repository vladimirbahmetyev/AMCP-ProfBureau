...
# регистрация
# авторизация
# подгрузка заданий, новостей пользователя + заданий комиссий (при входе вк лк)
# создание/удаление нового задания (удаление == отметка is_done)
# создание/удаление новости (удаление == отметка !is_actual)
# подгрузка отправленных заданий комиссии (для преда)
# проверка задания предом
# подгрузка членов комиссии
# взятие задания (если оно еще не взято)
# отправление задания на проверку
